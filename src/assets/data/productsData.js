...
for (let i = 0; i < count; i++) {
  ...
  products.push({
    ...
    // Gunakan variabel yang sudah dibuat di atas untuk properti 'price'
    price: `${(numericPrice + i * 100).toLocaleString("id-ID")}`, // Ubah harga
